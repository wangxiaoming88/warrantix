...
public class WalletProductList extends ArrayAdapter<String> {
    ...
    public WalletProductList(Activity context, String[] name, String[] name0, String[] name1, String[] days, String[] imageId) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        serviceBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                //...
                Intent mIntent = new Intent(getContext(),ProductsDetailScheduleService.class);

...
public class WalletBrandInsuranceList extends ArrayAdapter<String> {

    private final Activity context;
    private final String[] name,place;
    private final String[] imageId;

    public WalletBrandInsuranceList(Activity context, String[] name, String[] place, String[] imageId) {

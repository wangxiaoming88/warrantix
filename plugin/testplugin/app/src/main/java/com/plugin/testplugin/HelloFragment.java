...
//import com.warrantix.consumer.WarrantixApplication;
//import com.warrantix.consumer.loader.plugin.WXResources;
//import com.warrantix.consumer.activities.BaseActivity;

//
// Not used : HelloFragment
//
...
//
////		WXResources res = WXResources.getResource(HelloFragment.class);
//
...
//						Intent i = new Intent(Intent.ACTION_VIEW, Uri.parse(WarrantixApplication.PRIMARY_SCHEME + "://pickname?selection=" + name));
//
//						// We need a result, the result will be callback in
//						// onActivityResult()
//						((BaseActivity)getActivity()).startActivityForResult(i, 1);
//					}
//				});
//	}
//
